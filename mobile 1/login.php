        ...
        <div data-role="page">
            <div data-role="main" data-theme="a" >
                ...
                <div class="ui-content center-wrapper">                
                    ...
                    <div data-role="header"><h3>Iniciar sesión</h3></div><br>
                        <fieldset data-role="control-group" data-type="vertical">                                                      
                            ...
                            <input type="password" name="pswd" id="pswd" placeholder="Contraseña" data-clear-btn="true"><br>
                        </fieldset>
                        <div class="center-wrapper">
                            <button name="submit" type="submit" data-inline="true">Iniciar sesión</button>
                        </div>
                    </form>
                </div>
            </div>        
